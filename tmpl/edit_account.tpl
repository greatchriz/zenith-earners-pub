            ...
            <div class="basic-form">
                <form action="" method=post onsubmit="return checkform()" name=editform>
                    ...
                    <ul style="color:red">
                        ...
                        <li>Transaction Code is too small, please enter at least {$settings.min_user_password_length}
                            chars!
                            {/if}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type=text  value='{$userinfo.username}' class="form-control" disabled>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type=text  value='{$userinfo.date_register}' class="form-control" disabled>
                        </div>
                    </div>
    
                    
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label">Your Full Name:</label>
                        <div class="col-sm-9">
                    ...
                    <tr>
                        <td>Your Address:</td>
                        <td><input type=text name=address value="{$userinfo.address|escape:" quotes"}" class=inpts
                                size=30></td>
                    </tr>
                    <tr>
                        <td>Your City:</td>
                        <td><input type=text name=city value="{$userinfo.city|escape:" quotes"}" class=inpts size=30>
                        </td>
                    </tr>
                    <tr>
                        <td>Your State:</td>
                        <td><input type=text name=state value="{$userinfo.state|escape:" quotes"}" class=inpts size=30>
                        </td>
                    </tr>
                    <tr>
                        <td>Your Zip:</td>
                    ...
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label">Current Transaction Code:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label">New Transaction Code:</label>
                        <div class="col-sm-9">
                            <input type=password name=transaction_code value='' class="form-control">
                        </div>
                    </div>
                    
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label">Retype Transaction Code:</label>
                        <div class="col-sm-9">
                            <input type=password name=transaction_code2 value='' class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label">Your {$ps.name} acc no:</label>
                        <div class="col-sm-9">
                            {if $settings.usercanchangeegoldacc == 0 && $ps.account !=
                            ''}{$ps.account|escape:html}{else}
                            
                            
                            <input type=text name="pay_account[{$ps.id}]"
                                value="{$frm.pay_account[$ps.id]|default:$ps.account|escape:html}" class="form-control"
                    ...
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label">Your {$p.name} {$ps.name}:</label>
                        <div class="col-sm-9">
                            {if $settings.usercanchangeegoldacc == 0 && $ps.value !=
                            ''}{$ps.value|escape:html}{else}
                            <input type=text name="pay_account[{$p.id}][{$ps.name|escape:html}]"
                                value="{$frm.pay_account[$p.id][$ps.name]|default:$ps.value|escape:html}" class="form-control">
                            {/if}
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label">Your E-mail address:</label>
                        <div class="col-sm-9">
                            {if $settings.usercanchangeemail == 1}
                            <input type=text name=email value='{$userinfo.email|escape:"quotes"}' class="form-control">
                    ...
                    <tr>
                        ...
                        <td>{if $userinfo.rcb_lock}{$userinfo.rcb}%{else}<input type=text class=inpts size=30 name="rcb"
                                value="{$frm.rcb|default:$userinfo.rcb|number_format:2}">{/if}</td>
                    </tr>
                    {/if}
                    {if $userinfo.admin_auto_pay_earning == 1}
                    <tr>
                        <td colspan=2><input type=checkbox name=user_auto_pay_earning value=1 {if
                                $userinfo.user_auto_pay_earning==1}checked{/if}> Receive earnings directly to e-currency
                            account</td>
                    </tr>
                    {/if}
                    {if $settings.use_transaction_code_edit_account == 1}
                    ...
                    <input type=submit class="btn btn-primary" value="Change Account data">
